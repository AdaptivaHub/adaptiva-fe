 ...
 * 
 * Provides client-side data quality analysis for quick feedback.
 * Note: For production use, prefer the backend `/api/quality/analyze` endpoint
 * which provides more comprehensive analysis.
 */

import type { DataQualityIssue, ColumnIssue, DataQualityReport } from '@/types';

// Re-export types for convenience
export type { DataQualityIssue, ColumnIssue, DataQualityReport };
 ...
 * @returns DataQualityReport with quality score and issues
 */
